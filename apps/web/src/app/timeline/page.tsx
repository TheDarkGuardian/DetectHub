...
export default function TimelinePage() {
  const activeReport = MOCK_REPORTS[0];
    ...
    <DashboardShell>
      <div>
        ...
        <p className="text-xs text-zinc-400 mt-1">
          Chronological cross-artifact correlation for <span className="text-zinc-200 font-semibold">{activeReport.targetUsername}</span> ({activeReport.id})
        </p>
      </div>
